...
var settings = new
{
    ...
    Packages = new PackageVersion[]
    {
        ...
        new("SkiaSharp",                             "3.116.1"),
        new("MQTTnet",                               "4.3.7.1207"),
        new("AngleSharp",                            "1.1.2"),
        new("StreamJsonRpc",                         "2.20.20"),
        new("System.Data.SQLite.Core",               "1.0.119"),
        new("Npgsql.EntityFrameworkCore.PostgreSQL", "9.0.2"),
        new("Microsoft.EntityFrameworkCore.Sqlite",  "9.0.0"),
        new("ClosedXML",                             "0.104.2"),
        new("Kokuban",                               "0.2.0"),
